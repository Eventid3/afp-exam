...
- **Ports**: Domænets grænseflade til omverdenen. Specificerer, *hvad* der er brug for (f.eks. "gem bruger"). I FP er dette ofte blot en funktionstype.
...
- **Problemer**:
    - Umulig at enhedsteste isoleret.
    - Logik kan ikke genbruges med en anden type lager (f.eks. database).
    - Ren logik er viklet sammen med uren I/O.
-->
---
