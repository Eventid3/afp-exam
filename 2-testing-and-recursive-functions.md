...
<!-- Emne: Test af rekursive funktioner med property-based testing for robusthed. -->
---
...
- OBS: Vores `length` er IKKE halerekursiv pga. `1 + ...` operationen *efter* kaldet.
-->
---
...
- Eksempel: `reverse (reverse xs) = xs` skal gælde for *alle* lister `xs`.
